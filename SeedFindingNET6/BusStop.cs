...
namespace SeedFindingNET6
{
    public class BusStop : Location
    {
        ...
        static BusStop()
        {
            ...
            {
                [0] = new List<SpawnChance>() { new SpawnChance(18, 0.9), new SpawnChance(20, 0.4), new SpawnChance(22, 0.7) },
                [1] = new List<SpawnChance>() { new SpawnChance(396, 0.4), new SpawnChance(398, 0.4), new SpawnChance(402, 0.7) },
                [2] = new List<SpawnChance>() { new SpawnChance(406, 0.6), new SpawnChance(408, 0.4) },
                [3] = new List<SpawnChance>() { new SpawnChance(414, 0.33), new SpawnChance(418, 0.6), new SpawnChance(283, 0.5) }
            };
        }
