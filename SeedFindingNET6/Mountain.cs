...
namespace SeedFindingNET6
{
    public class Mountain : Location
    {
        ...
        static Mountain()
        {
            ...
            {
                [0] = new List<SpawnChance>() { new SpawnChance(20, 0.7), new SpawnChance(16, 0.5) },
                [1] = new List<SpawnChance>() { new SpawnChance(396, 0.5), new SpawnChance(398, 0.8) },
                [2] = new List<SpawnChance>() { new SpawnChance(404, 0.4), new SpawnChance(406, 0.4), new SpawnChance(408, 0.9) },
                [3] = new List<SpawnChance>() { new SpawnChance(414, 0.85), new SpawnChance(418, 0.9), new SpawnChance(283, 0.5) }
            };
        }
